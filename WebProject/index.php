...
<html xmlns:fb="http://ogp.me/ns/fb#" lang="en">
  <head>
    ...
    <!-- Persuativa Skunkworks Libraries -->
  ...
  <body>
    ...
    <header class="clearfix">
      ...
      <div>
        <h1>Sieg heil Creator, <strong><?php echo he(idx($basic, 'name')); ?></strong></h1>
        <p class="tagline">
          Esta es tu app
        ...
        <div id="share-app">
          <p>Comparte esta app:</p>
          <ul>
            <li>
              <a href="#" class="facebook-button" id="postToWall" data-url="<?php echo AppInfo::getUrl(); ?>">
                <span class="plus">Publicar en el muro</span>
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="#" class="facebook-button apprequests" id="sendRequest" data-message="Test this awesome app">
                <span class="apprequests">Enviar requerimiento</span>
              </a>
            </li>
          </ul>
        </div>
      ...
      <div>
        <h1>Bienvenidos</h1>
        <p>Dale click en el botón de "Me gusta*" y comprueba qué tanto sabes de sexualidad</p>
        <div class="fb-login-button" data-scope="user_likes,user_photos">Me gusta*</div>
      </div>
      <?php } ?>
    </header>

    <section id="get-started">
      <p>Habla Serio <span>Sexualidad</span>!</p>
      <a href="https://devcenter.heroku.com/articles/facebook" target="_top" class="button">Arriesgate a confirmar si lo que sabes es cierto.</a>
    </section>
    ...
    <!-- Persuativa Container  -->
    <div id="container">
    	<div class="friends">
    	<div class="list">
       	<h3>Algunos de tus amigos</h3>
        <ul class="friends">
          <?php
    ...
    <section id="samples" class="clearfix">
      <h1>Ejemplos de Facebook Graph API</h1>
      ...
      <div class="list">
        <h3>Amigos usando esta aplicación</h3>
        <ul class="friends">
          <?php
